# FC-PLAY — PERFECT EXECUTION

## Identity
Building **FC-Play** — multi-provider model gateway. 20+ providers. One endpoint.

## Core Principles
1. **Beautiful UX** — Warm amber admin console + Rich TUI dashboard

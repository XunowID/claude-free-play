...
#
# Or with extras:
#   curl -fsSL https://raw.githubusercontent.com/XunowID/claude-free-play/main/scripts/install.sh | sh -s -- --voice
# =============================================================================

set -e

# ─── Configuration ──────────────────────────────────────────────────────────
REPO="git+https://github.com/XunowID/claude-free-play.git"
PYTHON_VERSION="3.12"
MIN_UV="0.4.0"
...
echo ""
echo "Need help? Open an issue: https://github.com/XunowID/claude-free-play/issues"
echo ""
